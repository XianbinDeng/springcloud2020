...
public class PaymentController {
    ...
    public CommResult createPayment(PaymentModel paymentModel){
       return restTemplate.postForObject(url+"/payment/create",paymentModel,CommResult.class);
    }

    @GetMapping(value = "/consumer/payment/get/{id}")
    public CommResult createPayment(@PathVariable Long  id){
        return restTemplate.getForObject(url+"/payment/get/"+id,CommResult.class);
    }
